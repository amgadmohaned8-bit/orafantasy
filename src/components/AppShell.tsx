...
const ICONS: Record<IconName, ReactNode> = {
  ...
  /* Rebuilds the whole squad — a full-cycle refresh. */
  wildcard: (
    <>
  ...
  /* A royal crown for the captain's armband, tripled. */
  tripleCaptain: (
    <path d="M3 18h18l-1.6-8.4-4.4 3.2L12 5l-3 7.8-4.4-3.2L3 18Z" />
  ),
  /* A lightning bolt — the bench getting switched on. */
  benchBoost: <path d="M13 2 4 14h6l-1 8 9-12h-6l1-8Z" />,
  /* Small armband mark, used on captain/vice-captain shirt tiles. */
  armband: (
    <>
      <path d="M4 8h16v4a8 8 0 0 1-16 0V8Z" />
